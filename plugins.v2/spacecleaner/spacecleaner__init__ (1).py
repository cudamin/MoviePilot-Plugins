...
class SpaceCleaner(_PluginBase):
                            ...
                            {"component": "VExpansionPanelText", "content": [
                                {
                                    ...
                                    "content": [
                                        ...
                                        {"component": "VRow", "content": [
                                            ...
                                            {"component": "VCol", "props": {"cols": 12, "md": 4}, "content": [{"component": "VSwitch", "props": {"model": "delete_same_size", "label": "联动删除下载器中同大小且名称相同的种子"}}]},
                                        ]},
                                        {"component": "VRow", "content": [
            ...
            if self._delete_same_size:
                ...
                if src:
                    try:
                        ...
                        pass
                self._delete_linked_torrents(chain, display_name,
                                             match_size=src_size,
    ...
    def _delete_linked_torrents(self, chain, name, match_size=None, all_torrents=None):
        """删除下载器中同时匹配名称和大小的种子。match_size 非 None 时只删大小相同（误差 <1MB）的种子。"""
        if not all_torrents:
            return
